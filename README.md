...
> Rewair is experimental firmware. Read the
> [current status](docs/status.md) before flashing. If something goes wrong,
> start with the [recovery guide](tools/recovery/README.md).
