 ...
 * Awair routes the EMW3165 debug console to USART1 TX PB6 / RX PA10.
 */
...
/* Awair-specific line: stock firmware toggles GPIOB12 low/high to restart the
 * STM32F103 sensor/display board.
 */
#define AWAIR_SENSOR_RESET ( WICED_GPIO_18 )
